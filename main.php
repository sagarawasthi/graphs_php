...
<td align="left">
  ...
  <td><input type="text" name="graphValues" maxlength="200" style="width:220px" value="<? echo $graphValues; ?>"></td>
  </tr><tr>
  <td align="right">Labels (comma-separated):</td>
  <td><input type="text" name="graphLabels" maxlength="200" style="width:220px" value="<? echo $graphLabels; ?>"></td>
  </tr><tr>
  <td align="right">Bars Width:</td>
  <td><input type="text" name="graphBarWidth" maxlength="3" style="width:30px" value="<? echo $graphBarWidth; ?>"></td>
  </tr><tr>
  <td align="right">Bars Length Ratio (0.1 - 2.9):</td>
  <td><input type="text" name="graphBarLength" maxlength="3" style="width:30px" value="<? echo $graphBarLength; ?>"></td>
  </tr><tr>
  <td align="right">Labels Font Size:</td>
  <td><input type="text" name="graphLabelSize" maxlength="2" style="width:30px" value="<? echo $graphLabelSize; ?>"></td>
  </tr><tr>
  <td align="right">Values Font Size:</td>
  <td><input type="text" name="graphValuesSize" maxlength="2" style="width:30px" value="<? echo $graphValuesSize; ?>"></td>
  </tr><tr>
  <td align="right">Percentage Font Size:</td>
  <td><input type="text" name="graphPercSize" maxlength="2" style="width:30px" value="<? echo $graphPercSize; ?>"></td>
  </tr><tr>
  <td align="right">Graph Padding:</td>
  <td><input type="text" name="graphPadding" maxlength="2" style="width:30px" value="<? echo $graphPadding; ?>"></td>
  </tr><tr>
  <td colspan="2">&nbsp;</td>
  </tr><tr>
...
<td align="right">
  ...
  <td><input type="text" name="graphBGColor" size="14" maxlength="14" value="<? echo $graphBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Graph Border:</td>
  <td><input type="text" name="graphBorder" size="14" maxlength="30" value="<? echo $graphBorder; ?>"></td>
  </tr><tr>
  <td align="right">Bars Color:</td>
  <td><input type="text" name="graphBarColor" size="14" maxlength="14" value="<? echo $graphBarColor; ?>"></td>
  </tr><tr>
  <td align="right">Bars BG Color:</td>
  <td><input type="text" name="graphBarBGColor" size="14" maxlength="14" value="<? echo $graphBarBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Bars Border:</td>
  <td><input type="text" name="graphBarBorder" size="14" maxlength="30" value="<? echo $graphBarBorder; ?>"></td>
  </tr><tr>
  <td align="right">Labels Color:</td>
  <td><input type="text" name="graphLabelColor" size="14" maxlength="14" value="<? echo $graphLabelColor; ?>"></td>
  </tr><tr>
  <td align="right">Labels BG Color:</td>
  <td><input type="text" name="graphLabelBGColor" size="14" maxlength="14" value="<? echo $graphLabelBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Labels Border:</td>
  <td><input type="text" name="graphLabelBorder" size="14" maxlength="30" value="<? echo $graphLabelBorder; ?>"></td>
  </tr><tr>
  <td align="right">Values Color:</td>
  <td><input type="text" name="graphValuesColor" size="14" maxlength="14" value="<? echo $graphValuesColor; ?>"></td>
  </tr><tr>
  <td align="right">Values BG Color:</td>
  <td><input type="text" name="graphValuesBGColor" size="14" maxlength="14" value="<? echo $graphValuesBGColor; ?>"></td>
  </tr><tr>
  <td align="right">Values Border:</td>
  <td><input type="text" name="graphValuesBorder" size="14" maxlength="30" value="<? echo $graphValuesBorder; ?>"></td>
  </tr></table>
</td>
</tr></table><br>
